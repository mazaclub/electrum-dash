...
from electrum_ion.util import AlreadyHaveAddress, print_error
...
class MasternodeManager(object):
    ...
    def get_masternode_outputs(self, domain = None, exclude_frozen = True):
        ...
        # Valid outputs have a value of exactly 1000 ION and
    ...
    def check_can_sign_masternode(self, alias):
        ...
        if mn.vin.get('value', 0) != bitcoin.COIN * 1000:
            raise Exception('Masternode requires a collateral 1000 ION output.')
