...
_ = lambda x:x
#from i18n import _
from electrum_ion.wallet import WalletStorage, Wallet
from electrum_ion.util import format_satoshis, set_verbosity, StoreDict
from electrum_ion.bitcoin import is_valid, COIN, TYPE_ADDRESS
from electrum_ion.network import filter_protocol
