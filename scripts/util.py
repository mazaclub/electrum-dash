import select, time, electrum_ion, Queue
from electrum_ion import Connection, Interface, SimpleConfig
from electrum_ion.network import filter_protocol, parse_servers
from collections import defaultdict

# electrum_ion.util.set_verbosity(1)
